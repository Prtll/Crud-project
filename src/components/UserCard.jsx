  ...
  return (
    <article className='user'>
      ...
      <ul className='user__list'>
        <li className='user__item'><span className='user__span'><i className="user__email fa-solid fa-envelope"></i> Email</span>{user.email}</li>
        <li className='user__item'><span className='user__span'> <i className="user__gift fa-solid fa-gift"></i> Birthday</span>{user.birthday}</li>
      </ul>
